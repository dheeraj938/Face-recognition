...
known_person_image = face_recognition.load_image_file(r"asit.jpg")
known_person1_image = face_recognition.load_image_file(r"dheeraj.jpg")
known_person2_image = face_recognition.load_image_file(r"modi.jpeg")
known_person3_image = face_recognition.load_image_file(r"Virat_Kohli.jpg")
known_person4_image = face_recognition.load_image_file(r"yogi.jpeg")
known_person5_image = face_recognition.load_image_file(r"ronaldo.png")
